...
# Ατομική αναφορά
Η τελική ατομική αναφορά θα πρέπει να σταλεί στο τέλος της 9ης εβδομάδας σε αυτό εδώ το αποθετήριο στον φάκελο `reports`, σύμφωνα με τις [οδηγίες αποστολής παραδοτέου](https://courses-ionio.github.io/help/submit/). Η τελική αναφορά περιέχει λινκ προς τα επιμέρους αποθετήρια των παραδοτέων, καθώς και επιπλέον τεκμηρίωση για τις ενέργειες που κάνατε και ανεξάρτητα από τον βαθμό ολοκλήρωσης στα ζητούμενα.
